import Bages from "../elements/Bages";
        ...
        <>
            <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    <Bages>
                        <Bages.Icons icon={<FaMoneyBillWaveAlt className="text-2xl" />} className="from-blue-600 to-blue-400 text-white shadow-blue-500/40" />
                        <Bages.Description Title="Today's Money" Value="$53k" />
                        <Bages.Status Persen="+55%" Period="than last week" />
                    </Bages>
                </div>
                <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    <Bages>
                        <Bages.Icons icon={<FaUser className="text-2xl" />} className="from-pink-600 to-pink-400 text-white shadow-pink-500/40" />
                        <Bages.Description Title="Today's Users" Value="2,300" />
                        <Bages.Status Persen="+3.48%" Period="than last month" />
                    </Bages>
                </div>
                <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    <Bages>
                        <Bages.Icons icon={<FaUserPlus className="text-2xl" />} className="from-green-600 to-green-400 text-white shadow-green-500/40" />
                        <Bages.Description Title="New Clients" Value="3,462" />
                        <Bages.Status Persen="-2.01%" Period="than yesterday" />
                    </Bages>
                </div>
                <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    <Bages>
                        <Bages.Icons icon={<FaSignal className="text-2xl" />} className="from-orange-600 to-orange-400 text-white shadow-orange-500/40" />
                        <Bages.Description Title="Total Sales" Value="$103,430" />
                        <Bages.Status Persen="+5.72%" Period="than last month" />
                    </Bages>
                </div>
            </div>
